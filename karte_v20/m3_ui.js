...
(function () {
  ...
  M3.userMenu = function (btn) {
    ...
    openMenu(btn, [{ html: esc(mail || 'ログイン中'), muted: true }, { html: 'ID管理（ユーザー管理）', fn: () => openUserManager(), sep: true }, { html: '負担割合ルール一覧', fn: () => openInsuranceRuleRef() }, { html: 'ログアウト', fn: () => handleLogout(), sep: true }]);
  };
